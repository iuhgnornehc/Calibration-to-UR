...
class NatNetClient:
    ...
    # def getRigidBody(self, ID):
    # Unpack a rigid body object from a data packet
    def __unpack_rigid_body(self, data: object, major: object, minor: object, rb_num: object) -> object:
        offset = 0
    ...
    def __unpack_rigid_body_data(self, data, packet_size, major, minor):
        ...
        self.rigid_body = rigid_body_data.rigid_body_list
    ...
    def get_rigid_body(self, id):
        # if id != 2:
        #     pass
        if len(self.rigid_body) >= id:
            return self.rigid_body[id-1]
        else:
            return None
